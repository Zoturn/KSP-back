...
lines.push(
  ...
  '',
  'THEN, 4: does this commit change what the project IS, enough that the GitHub',
  'repository description is now wrong? Only when it does — a new capability, a',
  'stack change, a phase finishing, scaffolding first appearing. Routine commits',
  'do not touch it. If it is stale, PROPOSE a new one-line description and WAIT:',
  'the description is public, so it is for the user to decide, never an auto push.',
  '',
